                                    ...
                                    <form id="dataForm" name="dataForm" enctype="multipart/form-data"  class="form form-horizontal">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-4 col-form-label">
                                                        <label for="fname-icon">Author Image</label>
                                                    </div>
                                                    <div class="col-sm-8">
													     <img src="{{asset('SettingAuthorFolder/'.$allData->author_image)}}" style="width:200px" id="author_image_pre" >
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">
																<i data-feather='file-text'></i>
                                                            ...
                                                            <input type="file" id="author_image" class="form-control" name="author_image" value="{{$allData->author_image}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-4 col-form-label">
                                                        <label for="fname-icon">Author name</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" id="blog_author" class="form-control" name="blog_author" value="{{$allData->blog_author}}" placeholder="Enter Author Name">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-4 col-form-label">
                                                        <label for="fname-icon">Author designation</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" id="blog_author_designation" class="form-control" name="blog_author_designation" value="{{$allData->blog_author_designation}}" placeholder="Enter Author Designation">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-4 col-form-label">
                                                        <label for="fname-icon">Speed system (Browse site without loading)</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <select class="custom-select form-control" id="speed_system" data-placeholder="Type to search cities" name="speed_system">
                                                                <option value="0" @if($allData->speed_system == 0 ) selected @endif >No</option>
                                                                <option value="1" @if($allData->speed_system == 1 ) selected @endif >Yes</option>
                                                             </select>
                                                        </div>
                                                    </div>
                                                </div>
     ...
     $.ajaxSetup({
         headers: {
	        ...
	        $('#author_image').change(function(){
                ...
                reader.onload = (e) => {
                    $('#author_image_pre').attr('src', e.target.result);
                }
           ...
           success: function (data) {
               ...
               $('#author_image').val('');
               $('#author_image_pre').attr('src', '/SettingAuthorFolder/'+data.author_image);			   
               ...
               $('#blog_author').val(data.blog_author);
               $('#blog_author_designation').val(data.blog_author_designation);
               $('#speed_system').val(data.speed_system);
