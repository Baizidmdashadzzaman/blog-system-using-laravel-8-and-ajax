    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item ">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item ">
            <a href="{{route('admin.blog.list')}}" class="nav-link {{ Request::is('admin-dashboard/blog-list') ? 'active' : '' }}  ">
              <i class="far fa-circle nav-icon"></i>
              <p>Blog</p>
            </a>
          </li>
          <li class="nav-item ">
            <a href="{{route('admin.contactmessage.list')}}" class="nav-link {{ Request::is('admin-dashboard/contactmessage-list') ? 'active' : '' }}  ">
              <i class="far fa-circle nav-icon"></i>
              <p>Contact Message</p>
            </a>
          </li>
