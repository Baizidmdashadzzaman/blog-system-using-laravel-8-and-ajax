            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                        ...
                        <td>
                          @if(in_array(5, $permission))
                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                             ...
                             <input type="checkbox" data-id="5" class="checkModule custom-control-input"
                              name="userPermission" 
                            ...
                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                             ...
                             <input type="checkbox" data-id="5" class="checkModule custom-control-input" 
                             name="userPermission"  id="customSwitch15">
                             <label class="custom-control-label" for="customSwitch15">
                                  <span class="switch-icon-left"><i class="feather icon-check"></i></span>
                                 <span class="switch-icon-right"><i class="feather icon-check"></i></span>
                             </label>
                    ...
                    <tr>
                        <td>Contact us message Management</td>
                        <td>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="admin-read" checked="" disabled="">
                                <label class="custom-control-label" for="admin-read"></label>
                        ...
                        <td>
                          @if(in_array(6, $permission))
                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                             ...
                             <input type="checkbox" data-id="6" class="checkModule custom-control-input"
                              name="userPermission" 
                              id="customSwitch16" checked>
                            ...
                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                             ...
                             <input type="checkbox" data-id="6" class="checkModule custom-control-input" 
                             name="userPermission"  id="customSwitch16">
                             <label class="custom-control-label" for="customSwitch16">
                                  <span class="switch-icon-left"><i class="feather icon-check"></i></span>
                                 <span class="switch-icon-right"><i class="feather icon-check"></i></span>
                             </label>
