...
class SettingController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if($request->author_image != null)
		{
           $data ->author_image = time(). $_FILES["author_image"]["name"];
		}		
		...
		$data ->blog_author_designation = $request->blog_author_designation;
		$data ->speed_system = $request->speed_system;
		...
		if($request->author_image != null)
		{
           $source= $_FILES['author_image']['tmp_name'];
           @mkdir("SettingAuthorFolder");
           $destination="SettingAuthorFolder/".$data->author_image;
           $saveimage = move_uploaded_file($source,$destination);        
		}		
